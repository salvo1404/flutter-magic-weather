...
import 'package:magic_weather/widgets/forecast_horizontal_widget.dart';
...
class WeatherWidget extends StatelessWidget {
                  ...
                  Theme(
                    ...
                    child: ExpansionTile(
                      title: Row(
                        ...
                        children: <Widget>[
                          SizedBox(
                            ...
                            child: Text(
                              DateFormat('EEEE')
                                  .format(today.add(new Duration(days: day))),
                      ...
                      children: <Widget>[
                        ...
                        ForecastHorizontal(
                            weathers:
                                _filterForecastByDay(weather.forecast, day)),
  ...
  List<Weather> _filterForecastByDay(List<Weather> weathers, int day) {
    ...
    var offsetMidnight = DateTime.now().add(new Duration(
        days: day - 1,
        hours: 23 - timeOfDay.hour,
        minutes: 59 - timeOfDay.minute));

    var dayWeathers = weathers.where((item) {
      var forecastDate =
          new DateTime.fromMillisecondsSinceEpoch(item.time * 1000);
